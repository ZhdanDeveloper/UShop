 ...
 + SuperAdmin : 
      ...
      2. Управление пользователями (удаление, редактирование, назначение в администраторы, снятие с поста администратора).
         2.1. Присутствует поиск по имени
      ...
      4. Управление заказами (Просмотр заказа, и его выполнение(удаление из базы)).
         4.1. Присутствует поиск по номеру телефона
 + Admin : всё тоже что и SuperAdmin кроме назначени в администраторы и удаленя пользователя в роли SuperAdmin.
